...
internal class AvroAutofillAnalyzer : DiagnosticAnalyzer
{
    private const string KafkaAutofillAttributeName = "Avro.Autofill.AvroAutofillAttribute";

    internal static readonly DiagnosticDescriptor UnsupportedTypeError = new(
        id: "AVROA001",
        title: "Unsupported type in Avro schema",
        messageFormat: "{0}",
        category: "Avro.Autofill",
