...
namespace Avro.Autofill.IntegrationTests;
...
public class KafkaIntegrationTests : IDisposable
{
    ...
    public KafkaIntegrationTests()
    {
        ...
        var producerConfig = new ProducerConfig
        {
            ...
            ClientId = "avro-autofill-producer-test",
            Acks = Acks.All,
        ...
        {
            BootstrapServers = BootstrapServers,
            GroupId = $"avro-autofill-test-{Guid.NewGuid()}",
            ClientId = "avro-autofill-consumer-test",
